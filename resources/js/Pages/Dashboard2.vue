                    ...
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        <Menu as="div" class="ml-3 relative">
                            ...
                            >
                                ...
                                >
                                   <Link :href="route('logout')" method="post" class=" w-full p-6">Logout</Link>
                                    <!-- <MenuItem
...
import { SearchIcon, AcademicCapIcon, BeakerIcon, HomeIcon, UserGroupIcon } from '@heroicons/vue/solid'

import { Link } from '@inertiajs/inertia-vue3'

const navigation = [
    { name: 'Dashboard', href: route('dashboard'), icon: HomeIcon, current: route().current('dashboard') },
    { name: 'Faculty', href: route('faculty.index'), icon: AcademicCapIcon, current: route().current('faculty.*') },
    { name: 'Major', href: route('major.index'), icon: BeakerIcon, current: route().current('major.*') },
    { name: 'Student', href: route('student.index'), icon: UserGroupIcon, current: route().current('student.*') },
